...
import {
    ...
    ContactFormSection,
    ContactFormSubmit,
    ContactFormTextArea, ContentH, ContentP,
    Cover,
    EmailIcon,
    MessageIcon,
    OrgIcon,
...
const ContactForm = () => {
    return (
        <ContactFormContainer>
            ...
            <ContentP>
                See How We Can Secure Your Assets
                Let’s talk about how Thecyber Security can solve your cybersecurity needs. Fill out the contact form below to get started.
            ...
            <ContactFormCard>
                <ContactFormSection action="mailto:info@thecyber-sec.com">
                    <Cover>
                        ...
                        <CoverRight>
                            <ContactFormLabel htmlFor="name"><EmailIcon/></ContactFormLabel>
                    ...
                    <Cover>
                        <CoverLeft>
                            <ContactFormLabel htmlFor="company"><OrgIcon/></ContactFormLabel>
                            <ContactFormInput type="text" name="company" id="company" placeholder={"Company"}/>
                        </CoverLeft>
                        <CoverRight>
                            <ContactFormLabel htmlFor="website"><WebIcon/></ContactFormLabel>
                            <ContactFormInput type="text" name="website" id="website" placeholder={"Website"}/>
                        </CoverRight>
                    </Cover>

                    <CoverLeft>
                        <ContactFormLabel htmlFor="reason"><ReasonIcon/></ContactFormLabel>
                        <ContactFormInput type="text" name="reason" id="reason" placeholder={"Reason for contact"}/>
                    </CoverLeft>
                    <CoverLeft>
                        <ContactFormLabel htmlFor="message"><MessageIcon/></ContactFormLabel>
                        <ContactFormTextArea type="text" name="reason" id="message" placeholder={"Message"}/>
                    </CoverLeft>
                    <ContactFormSubmit type="submit" value="submit" placeholder={"Submit"}>Submit</ContactFormSubmit>
